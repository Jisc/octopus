...
export const octopusInformation: Interfaces.OctopusInformation = {
    publicationTypes: {
        PROBLEM: {
            ...
            editorPlaceholder:
                "Enter the main content of your Research Problem here. A 'research problem' publication defines a research problem or question. You will need to explain what is known so far about the problem, rather like the 'introduction' to a traditional paper. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        },
        HYPOTHESIS: {
            id: 'HYPOTHESIS',
        ...
        PROTOCOL: {
            ...
            editorPlaceholder:
                "Enter the main content of your Method here. A 'method' publication is a detailed description of ways of testing a hypothesis, or carrying out a theoretical rationale. You can include links to sites such as protocols.io to give more detail of the method if that would be helpful to readers. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        },
        DATA: {
            id: 'DATA',
            ...
            editorPlaceholder:
                "Enter the main content of your Results/Sources here. A “Results/Sources” publication can be either the raw data or summarised results collected according to an existing published 'method', or any existing evidence or material that form the object(s) of study for the research. It should describe the data, sources or results themselves, without any analysis. For results, it should provide details of the exact conditions under which the method was carried out and anything needed for an analysis or interpretation of the results. You can include links to the raw data files if they are in a specialist repository. Octopus is not a data repository itself. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        },
        ANALYSIS: {
            id: 'ANALYSIS',
            label: 'Analysis',
            ...
            editorPlaceholder:
                "Enter the main content of your Analysis here. An 'analysis' publication describes manipulations of results to help draw conclusions from them. For example, thematic or statistical analysis. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        },
        INTERPRETATION: {
            id: 'INTERPRETATION',
            ...
            editorPlaceholder:
                "Enter the main content of your Interpretation here. An 'interpretation' publication describes conclusions drawn from an 'analysis' of results. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        },
        REAL_WORLD_APPLICATION: {
            ...
            editorPlaceholder:
                'Enter the main content of your Applications/Implications here. An “Applications/Implications” publication describes how findings might have (or have had) an impact in the real world or for others in the field of study. This might be through a practical or policy application, and would be the appropriate publication type for case studies. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields.'
        },
        PEER_REVIEW: {
            id: 'PEER_REVIEW',
            label: 'Review',
            ...
            editorPlaceholder:
                "Enter the main content of your Peer Review here. A 'peer review' publication is open and post-publication. It should be a carefully considered and constructive critique of an existing publication by someone else. Your review should help other readers assess the publication, and should be written in the same style as any other kind of publication, with relevant references. Authors may reversion publications in the light of reviews. \nDo not include an abstract, bibliography or affiliations here, these can be entered in separate, dedicated fields."
        }
    },
    licences: {
        CC_BY: {
